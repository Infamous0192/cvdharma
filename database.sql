...
CREATE TABLE IF NOT EXISTS `gaji` (
  ...
  PRIMARY KEY (`id_gaji`),
  KEY `FK_gaji_proyek` (`id_proyek`),
  CONSTRAINT `FK_gaji_proyek` FOREIGN KEY (`id_proyek`) REFERENCES `proyek` (`id_proyek`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

/*!40000 ALTER TABLE `gaji` DISABLE KEYS */;
INSERT INTO `gaji` (`id_gaji`, `gaji`, `gaji_bersih`, `potongan`, `nik`, `tanggal_gaji`, `id_proyek`) VALUES
	(2, 20000, 15000, 5000, NULL, NULL, NULL),
	(3, 15000, 10000, 5000, NULL, NULL, NULL),
	(4, 10000, 8000, 2000, NULL, NULL, NULL),
	(5, 5000, 3500, 1500, NULL, NULL, NULL),
	(7, 4000, 4000, 500, '452435234', '2023-07-18', 11);
...
CREATE TABLE IF NOT EXISTS `pegawai` (
  ...
  KEY `FK_pegawai_proyek` (`id_proyek`),
  ...
  CONSTRAINT `FK_pegawai_proyek` FOREIGN KEY (`id_proyek`) REFERENCES `proyek` (`id_proyek`) ON DELETE SET NULL ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=latin1;

/*!40000 ALTER TABLE `pegawai` DISABLE KEYS */;
INSERT INTO `pegawai` (`id_pegawai`, `nik`, `nama`, `jenis_kelamin`, `agama`, `alamat`, `no_telp`, `email`, `tanggal_kontrak`, `id_jabatan`, `id_gaji`, `id_user`, `id_proyek`) VALUES
	(2, '', 'Ahmad Ridhoni', 'Pria', 'Islam', 'jalan pekauman', '0812528271', 'doni23@gmail.com', NULL, 9, 3, 4, NULL),
	(5, '', 'Taufik Fadil', 'Pria', 'Islam', 'Jalan Ramin', '08125342716', 'fadhil@email.com', NULL, 5, 3, 4, NULL),
	(7, '', 'M Anshari', 'Pria', 'Islam', 'Darma Praja', '081243217967', 'anshari@gmail.com', NULL, 1, 2, 3, NULL),
	(8, '', 'Diwantara Irwan Putra', 'Pria', 'Islam', 'citra land', '08123291837', 'taraputra@gmail.com', NULL, 7, 3, 4, NULL),
	(9, '', 'Muhammad Gema Andika', 'Pria', 'Islam', 'Citra Land', '081274520393', 'gemagte@gmail.com', NULL, 7, 3, 4, NULL),
	(10, '', 'Alip M Sevri', 'Pria', 'Islam', 'Komplek Mitramas Pramuka', '081273516987', 'alipman@gmail.com', NULL, 9, 3, 4, NULL),
	(11, '', 'usup', 'Pria', 'Islam', 'jalan ramin', '08128428461', 'usopp31@gmail.com', NULL, 13, 5, 4, NULL),
	(12, '', 'Afi ', 'Pria', 'Islam', 'Japos', '085235173969', 'afiman@gmail.com', NULL, 12, 5, 4, NULL),
	(13, '2352345346', 'Michael Soemanto', 'Pria', 'Protestan', 'Darma Praja', '081346713198', 'msoemanto@gmail.com', NULL, 5, 3, 4, 20),
	(14, '56724786345', 'Doloremque optio ut', 'Pria', 'Islam', 'Sed ex nisi cupidata', '08976452345', 'rubymojabo@mailinator.com', NULL, 12, 4, NULL, 12);
