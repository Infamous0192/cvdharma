<!DOCTYPE html>
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default" data-assets-path="<?= Router::baseUrl('assets') ?>" data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet" href="<?= Router::baseUrl('assets/vendor/fonts/boxicons.css') ?>" />
    ...
    <!-- Page CSS -->
    <link rel="stylesheet" href="<?= Router::baseUrl('assets/vendor/css/pages/page-auth.css') ?>" />
    <!-- Helpers -->
                    ...
                    <div class="card-body">
                        <div class="app-brand justify-content-center">
                            <a href="index.php" class="app-brand-link gap-2">
                                ...
                                <span class="app-brand-text demo text-body fw-bolder">SI Pegawai</span>
                            </a>
                        </div>
