            ...
            <div class="card-body">
                <form action="<?= Router::baseUrl('jembatan') ?>" method="post">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="panjang" name="panjang" placeholder="Panjang Jembatan" required />
                    </div>
                    <div class="mb-3">
                        <label class="form-label" for="lebar">Lebar Jembatan</label>
                        <input type="number" class="form-control" id="lebar" name="lebar" placeholder="Lebar Jembatan" required />
                    </div>
